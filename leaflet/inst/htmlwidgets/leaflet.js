...
(function() {
  ...
  methods.addRegPolygonMarkers =  function(lat, lng, layerId, group, options, clusterOptions, clusterId, popup) {
    var df = dataframe.create()
      .col('lat', lat)
      .col('lng', lng)
      .col('layerId', layerId)
    ...
    methods.addStarMarkers =  function(lat, lng, layerId, group, options, clusterOptions, clusterId, popup) {
    var df = dataframe.create()
      .col('lat', lat)
      .col('lng', lng)
      .col('layerId', layerId)
    ...
    addMarkers(this, df, group, clusterOptions, clusterId, function(df, i) {
      return L.starMarker([df.get(i, 'lat'), df.get(i, 'lng')], df.get(i));
    });
  };

   methods.addDiamondMarkers =  function(lat, lng, layerId, group, options, clusterOptions, clusterId, popup) {
    var df = dataframe.create()
      .col('lat', lat)
      .col('lng', lng)
      .col('layerId', layerId)
    ...
    addMarkers(this, df, group, clusterOptions, clusterId, function(df, i) {
      return L.diamondMarker([df.get(i, 'lat'), df.get(i, 'lng')], df.get(i));
    });
  };

methods.addPieChartMarkers =  function(lat, lng, layerId, group, options, clusterOptions, clusterId, popup) {
    var df = dataframe.create()
      .col('lat', lat)
      .col('lng', lng)
      .col('layerId', layerId)
    ...
    addMarkers(this, df, group, clusterOptions, clusterId, function(df, i) {
      return L.pieChartMarker([df.get(i, 'lat'), df.get(i, 'lng')], df.get(i));
    });
  };
